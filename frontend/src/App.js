  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/system-activity-logs" element={<ProtectedRoute><SystemActivityLogsPage /></ProtectedRoute>} />
        <Route path="/account-activity-logs" element={<ProtectedRoute><AccountActivityLogsPage /></ProtectedRoute>} />
