...
from controllers.check_permissions_controller import router as check_permissions_router
...
origins = [
    ...
    "http://localhost:3006",  
    "http://localhost:9600",
    "http://www.secuboard.live",
    "https://www.secuboard.live",
    "http://www.secuboard.live",
    "https://d34y7cryfef30p.cloudfront.net",
    "http://www.secuboard.live.s3-website-ap-southeast-2.amazonaws.com"
...
app.include_router(check_permissions_router)
