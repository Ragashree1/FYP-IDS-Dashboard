    ...
    try:
        ...
        if not existing_roles:
            ...
            roles = [
                    ...
                    Role(roleName="IT Manager"),
                    Role(roleName="Platform Admin"),
            ]
        ...
        if not existing_permissions:
            # Create default roles
            permissions = [
                Permission(permissionName="Blacklist UI"),
                Permission(permissionName="Event Logs"),
                Permission(permissionName="Generate Report"),
                Permission(permissionName="Offences"),
               ...
               # Permission(permissionName="Train Models"),
                ...
                Permission(permissionName="ML Predictions"),
                Permission(permissionName="organisation_requests"),
                Permission(permissionName="manage_organisation"),
                Permission(permissionName="view_log_forwarding"),
                Permission(permissionName="manage_api_access"),
                Permission(permissionName="platform_settings"),
                Permission(permissionName="System_Activity"),
                Permission(permissionName="Account_Activity"),
                Permission(permissionName="Reviews_Management"),
                Permission(permissionName="Settings"),
            ]
