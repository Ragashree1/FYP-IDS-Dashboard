...
# Load successfully installed community packages
@load ja3
@load zeek-sniffpass
@load log-add-http-post-bodies

# Load built-in detection scripts
...
# Make SQL injection detection more sensitive
@load policy/protocols/http/detect-sqli
redef HTTP::sqli_requests_threshold = 1.0;
redef HTTP::sqli_requests_interval = 1min;
redef ignore_checksums = T;

# Make SQL injection detection extremely sensitive
redef HTTP::sqli_requests_threshold = 1.0;
redef HTTP::sqli_requests_interval = 1min;

# Ignore checksums (to handle checksum offloading)
...
@load custom/attack-detection
@load custom/sql-injection
